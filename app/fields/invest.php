...
$invest
    ...
    ->addTab('Finansowanie', ['label'=>'Finansowanie','placement' => 'left'])
        ...
        ->endGroup()
    ->addTab('Galeria', ['label'=>'Galeria','placement' => 'left'])
        ->addGallery('gallerywiz', ['label'=>''])
    ->addTab('dziennik_budowy', ['label'=>'Dziennik Budowy','placement' => 'left'])
        ->addRepeater('note')
        ...
        ->endRepeater()
    ->addTab('Dodatkowe_informacje', ['label'=>'Dodatkowe informacje','placement' => 'left'])
        ->addGroup('extra', ['label'=> ' '])
            ->addFields(get_field_partial('components.text-info'))
            ->addImage('image', ['label'=> 'Zdjęcie'])
        ->endGroup()
    ;
